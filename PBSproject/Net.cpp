...
Net::Net() : DeformableObject(DeformableObject::VertexList_Rectangle(leftGoalPole,bottomGoal,goalWidth,goalHeight),DeformableObject::FaceList_Rectangle(),
						DeformableObject::Contour_Rectangle(),0.03f,1.0f,0.3f,0.3f,0.3f,0.3f) {

	textureName = "../images/net.png";
}
